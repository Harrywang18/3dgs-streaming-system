...
if __name__ == "__main__":
    ...
    ds_factors = [1, 2, 4, 8, 16] # Downsampling factors: 1 means original size, 2 means half size, 4 means quarter size, 8 means eighth size
    dataset_scene_map = {"db": ["playroom","drjohnson"], 
                        ...
                        #  "360": ["bonsai", "counter", "garden", "kitchen", "room"]}
                        "360": ["flowers", "treehill"]}
