...
function url_worker(self){
	let scene_name = 'garden'
    let root = 'https://localhost:8081/assets/data/'+scene_name+'/voxels_ilp/';
    let all_voxels;
    let downloader;
    ...
    let downloadLocks = {}; // Used to lock downloading voxels
...
async function main() {
    ...
    const voxel_url = new URL("https://localhost:8081/assets/data/"+scene_name+"/voxels_ilp/voxel_ilp.json");
    ...
    const frame = (now) => {
        ...
        //let camid = Math.floor(render_frame/3);
